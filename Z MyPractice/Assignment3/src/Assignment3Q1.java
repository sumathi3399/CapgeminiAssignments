...
public class Assignment3Q1 {
    public static void main(String[] args) {
    	...
    	person.add(new Person("Sumathi",100,90));
    	person.add(new Person("bhavani",150,60));
    	person.add(new Person("varma",160,100));
    	person.add(new Person("phani",150,80));
    	person.add(new Person("sai",180,50));
